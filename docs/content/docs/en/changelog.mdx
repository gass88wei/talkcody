...
- **Free Usage Expansion**: Added OpenCode Zen free provider for free GLM-4.7 model usage, now supporting 9 completely free usage methods. For details, refer to [TalkCody Free Usage Guide](/docs/guides/free-use).
